...
\abstract{
    ...
    The experimental results demostrate high detection performance with an mAP50 (mean average precision at IoU threshold of $0.50$) ranging from $0.766$ to $0.793$ on the test dataset, along with a short inference time of $133.30$ ms on the Jetson Nano device.
